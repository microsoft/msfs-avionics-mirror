...
import { G3000RadioType, G3000RadioUtils, TunableRadio } from '@microsoft/msfs-wtg3000-common';
    ...
    return (
      <div class={this.rootCssClass}>
        <div class='frequency-dialog-main-content'>
          ...
          >
            <img src='coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_find.png' />
            <div>Find</div>
          </GtcTouchButton>
          <GtcTouchButton
          ...
          >
            <img src='coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_flip_flop_arrow.png' />
            <div>XFER</div>
          </GtcTouchButton>
        </div>
