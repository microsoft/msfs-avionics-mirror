import {
  DisplayComponent, FacilityTypeMap, FacilityWaypoint, FSComponent, GeoPoint, GeoPointSubject, MutableSubscribable,
  NearestSubscription, SetSubject, Subject, Subscribable, SubscribableUtils, Subscription, UserSettingManager, VNode
...
import {
  ...
  DisplayPanesUserSettings, DisplayPaneViewKeys, DynamicListData, G3000NearestContext, NearestPaneSelectionData, NearestPaneSelectionType,
  NearestPaneViewEventTypes, NearestWaypointArray, NearestWaypointEntry, NearestWaypointFacilityType, NearestWaypointTypeMap
...
> extends GtcView<P> {
  ...
  protected readonly showOnMapIcao = this.selectedFacility.map(facility => facility?.icao ?? '');
