import {
  AdcEvents, ConsumerSubject, ControlEvents, DisplayField, FmcRenderTemplate, SimVarValueType, Subject, SwitchLabel, TextInputField, XPDRMode, XPDRSimVarEvents
 ...
 */
export class AtcControlPage extends WT21FmcPage {
  ...
  protected onInit(): void {
    ...
    const sub = this.bus.getSubscriber<XPDRSimVarEvents & AdcEvents>();
