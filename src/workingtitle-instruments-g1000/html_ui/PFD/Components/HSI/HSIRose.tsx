...
import { LNavDataEvents, NavIndicatorController, NavSensitivity, ObsSuspModes } from '@microsoft/msfs-garminsdk';
...
export class HSIRose extends DisplayComponent<HSIRoseProps> {
  ...
  public onAfterRender(): void {
    ...
    const xtkSub = xtkRounded.sub(xtkHandler, false, true);
