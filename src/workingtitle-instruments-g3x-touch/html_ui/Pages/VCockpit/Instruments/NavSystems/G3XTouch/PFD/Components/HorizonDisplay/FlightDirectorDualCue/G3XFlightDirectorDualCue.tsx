...
import './G3XFlightDirectorDualCue.css';

/**
 * Component props for {@link G3XFlightDirectorDualCue}.
 */
export interface G3XFlightDirectorDualCueProps extends HorizonLayerProps {
 ...
 */
export class G3XFlightDirectorDualCue extends HorizonLayer<G3XFlightDirectorDualCueProps> {
