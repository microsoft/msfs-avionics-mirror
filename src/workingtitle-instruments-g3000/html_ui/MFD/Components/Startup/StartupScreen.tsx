import {
  ...
  SetSubject, Subscribable, SubscribableUtils, UnitType, VNode
} from '@microsoft/msfs-sdk';

import { G3000FilePaths, G3000Version, GduSoftkeyInteractionEvent } from '@microsoft/msfs-wtg3000-common';
...
export class StartupScreen extends DisplayComponent<StartupScreenProps> {
  ...
  public onInteractionEvent(event: string): boolean {
    if (!this.isAlive) {
      throw new Error('StartupScreen: cannot invoke a dead screen');
    }
    ...
    if (event === GduSoftkeyInteractionEvent.SoftKey12) {
