import {
  BitFlags, CssRotateTransform, CssTransformBuilder, CssTransformChain, CssTransformSubject, CssTranslate3dTransform, CssTranslateTransform, ExpSmoother,
  FSComponent, HorizonLayer, HorizonLayerProps, HorizonProjection, HorizonProjectionChangeType, MathUtils, ObjectSubject, ReadonlyFloat64Array, Subject,
  Subscribable, SubscribableUtils, Subscription, UnitType, VNode
} from '@microsoft/msfs-sdk';

import { TcasRaCommandDataProvider } from '@microsoft/msfs-epic2-shared';
...
export class TcasRaPitchCueLayer extends HorizonLayer<TcasRaPitchCueLayerProps> {
  ...
  private updateSmoothedValues(elapsed: number): void {
    ...
    if (dt > 0 && tas !== null) {
      ...
      this.smoothedTas.set(this.tasSmoother.reset(0));
    }
  }
  ...
  private updateNoflyCue(
    ...
    const currentVs = this.props.verticalSpeed.get() ?? 0;
  ...
  public render(): VNode {
    return (
      ...
      >
        ...
        >
          <path d="M56 138H26L21 110L56 138Z" />
          <path d="M171 138H201L206 110L171 138Z" />
          <path d="M2 2L21 110M21 110L26 138H56M21 110L56 138M56 138H171M225 2L206 110M206 110L201 138H171M206 110L171 138" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <svg
          viewBox='0 0 227 139'
        ...
        >
          <path d="M56 2H26L21 30L56 2Z" />
          <path d="M171 2H201L206 30L171 2Z" />
          <path d="M2 138L21 30M21 30L26 2H56M21 30L56 2M56 2H171M225 138L206 30M206 30L201 2H171M206 30L171 2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <div
