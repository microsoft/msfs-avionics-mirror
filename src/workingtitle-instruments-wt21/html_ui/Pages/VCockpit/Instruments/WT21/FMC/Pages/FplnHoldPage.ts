...
import { RawFormatter, SimpleStringFormat } from '../Framework/FmcFormats';
 ...
 * FPLN HOLD page
 */
export class FplnHoldPage extends FmcPage {
  ...
  private readonly LegTimeField = new TextInputField(this, {
    formatter: {
  ...
  private readonly LegDistanceField = new TextInputField(this, {
    formatter: {
  ...
  private readonly ExitHoldField = new DisplayField<boolean>(this, {
    ...
    onSelected: async (): Promise<string | boolean> => {
      this.eventBus.getPublisher<ControlEvents>().pub('suspend_sequencing', !this.store.LnavSuspended.get());
      return true;
    }
  });
