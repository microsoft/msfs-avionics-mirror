import { ClockEvents, DisplayField, FmcPageLifecyclePolicy, FmcRenderTemplate, PageLinkField, Subject } from '@microsoft/msfs-sdk';
 ...
 */
export class WeatherPage extends WT21FmcPage {
  ...
  onInit(): void {
    ...
    const simTimeConsumer = this.bus.getSubscriber<ClockEvents>()
      .on('simTime')
      .atFrequency(1, true)
      .handle(() => {
