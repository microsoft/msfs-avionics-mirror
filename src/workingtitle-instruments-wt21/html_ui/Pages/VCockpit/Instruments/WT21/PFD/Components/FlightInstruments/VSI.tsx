import { AdcEvents, APEvents, ApproachGuidanceMode, APVerticalModes, AvionicsSystemState, AvionicsSystemStateEvent, ComponentProps, ConsumerSubject, DisplayComponent, EventBus, FSComponent, Subject, VNavEvents, VNavState, VNode } from '@microsoft/msfs-sdk';
...
export class VSI extends DisplayComponent<VSIProps> {
  ...
  private readonly advisoryVnavSetting = FmcUserSettings.getManager(this.props.bus).getSetting('advisoryVnavEnabled');
