...
import { FlightPlanLegListData, LegNameDisplay } from '@microsoft/msfs-wtg3000-common';
  ...
  public override render(): VNode {
    ...
    return (
      <div class="flight-plan-leg-display">
        ...
        {isFlyOver && <img class="leg-icon" src="coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_fly_over_wpt.png" />}
      </div>
    );
  }
