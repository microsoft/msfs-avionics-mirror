import {
  ComponentProps, ConsumerSubject, ControlSurfacesEvents, DisplayComponent, EventBus, FSComponent, VNode
} from '@microsoft/msfs-sdk';

import { PfdAileronTrimGaugeConfig } from './PfdAileronTrimGaugeConfig';
import { PfdRudderTrimGaugeConfig } from './PfdRudderTrimGaugeConfig';

import './PfdAileronRudderTrimGauge.css';

/**
 * Component props for {@link PfdAileronRudderTrimGauge}.
 */
export interface PfdAileronRudderTrimGaugeProps extends ComponentProps {
 ...
 */
export class PfdAileronRudderTrimGauge extends DisplayComponent<PfdAileronRudderTrimGaugeProps> {
  ...
  public render(): VNode | null {
    if (this.props.aileronTrimGaugeConfig && this.props.rudderTrimGaugeConfig) {
      return this.renderRudderAndAileron();
    } else if (this.props.aileronTrimGaugeConfig) {
      return this.renderRudderOrAileron('aileron');
    } else if (this.props.rudderTrimGaugeConfig) {
      return this.renderRudderOrAileron('rudder');
    } else {
      return null;
    }
  }
