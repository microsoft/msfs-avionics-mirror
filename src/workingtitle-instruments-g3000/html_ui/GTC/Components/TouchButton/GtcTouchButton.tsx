...
/**
 * Component props for GtcTouchButton.
 */
export interface GtcTouchButtonProps extends TouchButtonProps {
  /**
...
/**
 * A GTC version of {@link TouchButton}. Enables focus on drag by default, and provides convenience props for
 * handling drag behavior while in a scrollable list.
 */
export class GtcTouchButton extends DisplayComponent<GtcTouchButtonProps> {
  private readonly ref = FSComponent.createRef<TouchButton>();
