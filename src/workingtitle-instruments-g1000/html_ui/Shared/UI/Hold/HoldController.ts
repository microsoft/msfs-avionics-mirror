import { FlightPathUtils, FlightPlan, ICAO, LegTurnDirection, LegType, MagVar, NavMath, UnitType } from '@microsoft/msfs-sdk';
...
export class HoldController {
  ...
  public accept(): void {
    ...
    const leg = FlightPlan.createLeg({
      ...
      fixIcaoStruct: ICAO.stringV1ToValue(this.store.fixIcao.get()),
