import {
  ArrayUtils, DebounceTimer, Facility, FacilityType, FSComponent, ICAO, IntersectionFacilityUtils, MappedSubject,
  NodeReference, SearchTypeMap, Subject, VNode
  ...
  public request<T extends G3000WaypointSearchType>(input: GtcWaypointDialogInput<T>): Promise<GtcDialogResult<SearchTypeMap[T]>> {
    return new Promise<GtcDialogResult<SearchTypeMap[T]>>(resolve => {
      ...
      if (input.initialValue) {
        this.inputRef.instance.setValue(ICAO.getIdent(input.initialValue.icao));
