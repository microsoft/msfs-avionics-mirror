import { FSComponent, SubEventInterface, SubEvent, Subject } from '@microsoft/msfs-sdk';
...
export abstract class UiView<T extends UiViewProps = UiViewProps, RV = any, IV = any> extends UiControlGroup<T> {
  ...
  public onOpen: SubEventInterface<this, void> = new SubEvent<this, void>();
  public onClose: SubEventInterface<this, void> = new SubEvent<this, void>();
  public onAccept: SubEventInterface<this, RV | undefined> = new SubEvent<this, RV | undefined>();
