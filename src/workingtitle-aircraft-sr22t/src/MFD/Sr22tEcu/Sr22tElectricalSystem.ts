...
export class Sr22tElectricalSystem {
  ...
  private readonly batt1Amps = ConsumerValue.create(this.bus.getSubscriber<ElectricalEvents>().on('elec_bat_load_1').atFrequency(1), 0);
  private readonly batt2Amps = ConsumerValue.create(this.bus.getSubscriber<ElectricalEvents>().on('elec_bat_load_2').atFrequency(1), 0);
