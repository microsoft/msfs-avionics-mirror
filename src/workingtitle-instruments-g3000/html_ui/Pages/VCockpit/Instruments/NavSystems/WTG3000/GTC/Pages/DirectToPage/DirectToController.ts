  ...
  public activateSelected(): void {
    ...
    if (facility) {
      ...
      if (directToExistingData) {
        ...
        if (holdInfo) {
          HoldController.createAndInsertHold(this.fms, Fms.PRIMARY_PLAN_INDEX, holdInfo, facility.icao, segmentIndex, newSegmentLegIndex + 3);
        } else {
        ...
        if (holdInfo) {
          HoldController.createAndInsertHold(this.fms, Fms.DTO_RANDOM_PLAN_INDEX, holdInfo, facility.icao, 0, 2);
        }
      }
    }
  }
