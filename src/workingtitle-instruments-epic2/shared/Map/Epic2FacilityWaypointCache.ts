 ...
 */
export class Epic2FacilityWaypointCache implements FacilityWaypointCache {
  private static INSTANCE: Epic2FacilityWaypointCache | undefined;
  ...
  public get<T extends Facility>(facility: Facility): FacilityWaypoint<T> {
    const key = Epic2FacilityWaypointCache.getFacilityKey(facility);
   ...
   */
  public static getCache(bus: EventBus): Epic2FacilityWaypointCache {
    return Epic2FacilityWaypointCache.INSTANCE ??= new Epic2FacilityWaypointCache(bus, 1000);
  }
