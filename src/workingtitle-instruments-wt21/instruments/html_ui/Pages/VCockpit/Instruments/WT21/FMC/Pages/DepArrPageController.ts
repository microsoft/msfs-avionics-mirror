import {
  ApproachProcedure, DisplayField, EventBus, FlightPlannerEvents, FlightPlanOriginDestEvent, FlightPlanProcedureDetailsEvent, FmcRenderTemplate,
  FmcRenderTemplateColumn, FmcRenderTemplateRow, ICAO, OneWayRunway, PageLinkField, SimVarValueType, Subject, TextInputField, UnitType
    ...
    if (selectedApproach) {
      ...
      if (selectedApproach.isVisualApproach) {
        ...
        const renderItem = visualApprOffset ? new TextInputField<number | null>(this.page, {
          ...
          deleteAllowed: false,
          onModified: async (visualOffset: number | null) => { this.onVisualOffsetSet(visualOffset ?? 5); this.page.screen.clearScratchpad(); return true; },
        }) : '';
