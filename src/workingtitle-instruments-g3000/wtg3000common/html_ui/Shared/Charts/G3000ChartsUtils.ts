...
export class G3000ChartsUtils {
   ...
   */
  public static pageSelectionEquals(a: G3000ChartsPageSelectionData, b: G3000ChartsPageSelectionData): boolean {
  ...
  /**
   * Gets an array of G3000 chart page data from an array of chart metadata. The page data is ordered according to the
  ...
  public static async getPageDataFromMetadata(
    ...
    const pageDataArray: G3000ChartsPageData[] = [];
