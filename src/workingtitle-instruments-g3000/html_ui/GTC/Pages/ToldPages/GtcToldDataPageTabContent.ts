...
/**
 * A content component for a GTC Takeoff or Landing Data page tab.
 */
export interface GtcToldDataPageTabContent extends DisplayComponent<any>, GtcInteractionHandler {
