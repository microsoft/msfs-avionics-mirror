      ...
      <div class={`alpha-num-input ${this.props.class ?? ''}`} ref={this.el}>
        <GNSUiControl ref={this.root} isolateScroll>
          ...
          <div class='alpha-num-keyboard' ref={this.keyboardRef} >
            {this.props.enableKeyboard && <img ref={this.keyboardIcon} src='coui://html_ui/Pages/VCockpit/Instruments/NavSystems/GPS/Shared/Assets/keyboard.png' class='alpha-num-kb-icon' />}
