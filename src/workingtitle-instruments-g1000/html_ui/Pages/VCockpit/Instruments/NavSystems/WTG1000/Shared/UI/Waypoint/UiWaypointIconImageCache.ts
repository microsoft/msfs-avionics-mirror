import { DefaultWaypointIconImageCache, DefaultWaypointIconImageKey, WaypointIconImageCache } from 'garminsdk';

/**
 * A cache of UI waypoint icon images.
 */
export class UiMapWaypointIconImageCache {
  ...
  public static getCache(): WaypointIconImageCache {
    return UiMapWaypointIconImageCache.INSTANCE ??= this.createCache();
  }
