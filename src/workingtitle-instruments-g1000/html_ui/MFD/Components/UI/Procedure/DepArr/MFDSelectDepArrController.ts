import { AirportFacility, ArrivalProcedure, DepartureProcedure, EnrouteTransition, FlightPathCalculator, FlightPlan, RunwayTransition, Subject } from '@microsoft/msfs-sdk';
