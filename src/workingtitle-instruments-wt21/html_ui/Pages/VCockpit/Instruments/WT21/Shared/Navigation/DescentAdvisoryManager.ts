import { ClockEvents, ConsumerSubject, EventBus, FlightPlan, FlightPlannerEvents, LNavEvents, ObjectSubject, UnitType, VNavEvents, Wait } from '@microsoft/msfs-sdk';
import { WT21Fms } from '../FlightPlan/WT21Fms';
import { WT21VNavDataEvents } from './WT21VnavEvents';
import { DesAdvisoryDetails, WT21VnavUtils } from './WT21VnavUtils';
