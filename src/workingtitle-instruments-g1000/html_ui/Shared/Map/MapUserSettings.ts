...
import { MapDeclutterSettingMode, MapOrientationSettingMode, MapTerrainSettingMode, MapTrafficAlertLevelSettingMode, MapUserSettingTypes } from '@microsoft/msfs-garminsdk';
