import { AhrsEvents, AvionicsSystemState, AvionicsSystemStateEvent, ClockEvents, ComponentProps, DisplayComponent, EventBus, FSComponent, VNode } from '@microsoft/msfs-sdk';
