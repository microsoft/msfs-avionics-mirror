import { FlightPlanRouteManager, ReadonlyFlightPlanRoute, Subscription } from '@microsoft/msfs-sdk';
 ...
 */
export class GarminFlightPlanRouteSyncManager {
  private routeManager?: FlightPlanRouteManager;
  private routeLoader?: GarminFlightPlanRouteLoader;
  private routeProvider?: GarminFlightPlanRouteProvider;
   ...
   */
  public init(
    manager: FlightPlanRouteManager,
    loader: GarminFlightPlanRouteLoader,
    provider: GarminFlightPlanRouteProvider
  ): void {
    if (!this.isAlive) {
   ...
   */
  private onAvionicsRouteRequested(provider: GarminFlightPlanRouteProvider, manager: FlightPlanRouteManager, requestId: number): void {
   ...
   * @param manager The flight plan route manager through which to reply.
   */
  private async scheduleReplyToAvionicsRouteRequests(
    provider: GarminFlightPlanRouteProvider,
    manager: FlightPlanRouteManager,
  ): Promise<void> {
   ...
   * @param manager The flight plan route manager through which to reply.
   */
  private async replyToAvionicsRouteRequests(
    opId: number,
    provider: GarminFlightPlanRouteProvider,
    manager: FlightPlanRouteManager,
  ): Promise<void> {
    let route: ReadonlyFlightPlanRoute;
