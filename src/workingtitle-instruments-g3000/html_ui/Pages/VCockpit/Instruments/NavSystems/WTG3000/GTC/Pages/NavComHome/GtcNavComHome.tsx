import {
  AdcEvents, ComSpacing, ConsumerSubject, ControlEvents, DebounceTimer, FSComponent, MappedSubject, NavComSimVars, Publisher, RadioType, SetSubject,
  SoundPacket, SoundServerControlEvents, Subject, UserSetting, VNode, XPDRMode, XPDRSimVarEvents
...
export class GtcNavComHome extends GtcView<GtcNavComHomeProps> {
   ...
   */
  private get stbyUpImgSrc(): Subject<BtnImagePathHor | BtnImagePathVert> {
  ...
  private readonly com1StbyFreqUpImgSrc = Subject.create(this.isHrz ? BtnImagePathHor.ComBottomUp : BtnImagePathVert.ComBottomUp);
  private readonly com2StbyFreqUpImgSrc = Subject.create(this.isHrz ? BtnImagePathHor.ComBottomUp : BtnImagePathVert.ComBottomUp);
  ...
  public onAfterRender(): void {
    ...
    this.buttonEditingModeIsActive.sub((buttonEditingModeIsActive: boolean): void => {
      ...
      this.stbyUpImgSrc.set(buttonEditingModeIsActive ?
        (this.isHrz ? BtnImagePathHor.ComBottomDown : BtnImagePathVert.ComBottomDown) :
        (this.isHrz ? BtnImagePathHor.ComBottomUp : BtnImagePathVert.ComBottomUp));
    });
      ...
      <div class="gtc-page gtc-home-page nav-com-home">
        ...
        {this.props.gtcService.controlSetup === 'pfd' ?
          ...
          <div class={transponderClasses.join(' ')}>
            <BgImgTouchButton
              ...
              upImgSrc={isHrz ? BtnImagePathHor.XpdrTopUp : BtnImagePathVert.XpdrTopUp}
              downImgSrc={isHrz ? BtnImagePathHor.XpdrTopDown : BtnImagePathVert.XpdrTopDown}
            />
            <BgImgTouchButton
              class='audio-button-bottom'
              onPressed={this.onBottomTransponderButtonPressed}
              upImgSrc={isHrz ? BtnImagePathHor.XpdrBottomUp : BtnImagePathVert.XpdrBottomUp}
              downImgSrc={isHrz ? BtnImagePathHor.XpdrBottomDown : BtnImagePathVert.XpdrBottomDown}
            >
        ...
        <div class={`navcom-area-com1 nested-buttons${isHrz ? ' bordered' : ''}`}>
          <BgImgTouchButton
            ...
            upImgSrc={isHrz ? BtnImagePathHor.ComTopUp : BtnImagePathVert.ComTopUp}
            downImgSrc={isHrz ? BtnImagePathHor.ComTopDown : BtnImagePathVert.ComTopDown}
          >
            <div class='com-label com-active-label'>COM1</div>
            <div class={this.com1ActFreqClasses}>{this.com1ActiveFreqDisp}</div>
            <img class='com-arrow' src={BtnImagePathHor.DoubleArrow}></img>
          </BgImgTouchButton>
          <BgImgTouchButton
            class='com-button-bottom'
            onPressed={() => this.onStbyButtonPressed('COM1')}
            upImgSrc={this.com1StbyFreqUpImgSrc}
            downImgSrc={isHrz ? BtnImagePathHor.ComBottomDown : BtnImagePathVert.ComBottomDown}
          >
            <img class={this.com1StbyHighlightClasses}
              src={isHrz ? BtnImagePathHor.ComBottomHighlight : BtnImagePathVert.ComBottomHighlight}></img>
            ...
            {isHrz &&
              <img class={this.com1StbyBorderClasses}
                src={isHrz ? BtnImagePathHor.ComBottomBorder : BtnImagePathVert.ComBottomBorder}></img>
            }
          </BgImgTouchButton>
        </div>
        ...
        <div class={`navcom-area-micmon nested-buttons${isHrz ? ' bordered' : ''}`}>
          <BgImgTouchButton
            ...
            upImgSrc={isHrz ? BtnImagePathHor.MicUp : BtnImagePathVert.MicUp}
            downImgSrc={isHrz ? BtnImagePathHor.MicDown : BtnImagePathVert.MicDown}
          >
            <div class={this.mic1Classes}
              style={`background-image: url("${isHrz ? BtnImagePathHor.TriangleUp : BtnImagePathVert.TriangleLeft}")`}>1</div>
            <div class={this.mic2Classes}
              style={`background-image: url("${isHrz ? BtnImagePathHor.TriangleDown : BtnImagePathVert.TriangleRight}")`}>2</div>
          </BgImgTouchButton>
          <BgImgTouchButton
            label='MON'
            class='mic-mon-button mon-button'
            onPressed={this.onMonButtonPress}
            upImgSrc={isHrz ? BtnImagePathHor.MonUp : BtnImagePathVert.MonUp}
            downImgSrc={isHrz ? BtnImagePathHor.MonDown : BtnImagePathVert.MonDown}
          >
        ...
        {isHrz &&
          <div class="navcom-area-keypad">
            <ImgTouchButton
              ...
              imgSrc={BtnImagePathHor.FindIcon}
              label='Find'
            />
            <ImgTouchButton
            ...
            <ImgTouchButton
              ...
              imgSrc={BtnImagePathHor.DoubleArrow}
              label='XFER'
            />
          </div>
        }
