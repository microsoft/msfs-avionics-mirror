import {
  FSComponent, HardwareControlListProps, HardwareUiControl, HardwareUiControlList, HardwareUiControlProps, Subject, Subscribable, SubscribableUtils, UiControlEventHandler,
  UiControlEventHandlers, UiControlPropEventHandlers, VNode
...
export abstract class WT21UiControl<P extends WT21UiControlProps = WT21UiControlProps>
  ...
  public onAfterRender(thisNode: VNode): void {
    ...
    if (this.props.disabled) {
      SubscribableUtils.toSubscribable(this.props.disabled, true).sub((v) => this.setDisabled(v), true);
    }
  }
 ...
 */
export interface WT21UiControlListProps<T> extends UiControlPropEventHandlers<GuiUiControlEvents>, HardwareUiControlProps, HardwareControlListProps<T> {
}

/**
 * A list of WT21 UI controls.
 */
export abstract class WT21UiControlList<T, P extends WT21UiControlListProps<T> = WT21UiControlListProps<T>>
  extends HardwareUiControlList<T, GuiUiControlEvents, P>
  implements UiControlEventHandlers<GuiUiControlEvents> {
