import {
  Annunciation, AnnunciationType, ComponentProps, CompositeLogicXMLHost, DisplayComponent, EventBus, FSComponent, KeyEventData, KeyEvents, KeyEventManager,
  VNode, SoundServerController,
...
export class CAS extends DisplayComponent<CASProps> {
      ...
      case AlertState.New:
        if (active) {
          ...
          if (type == AnnunciationType.Caution && this.props.cautionSoundId !== undefined && !this.numActiveWarnings) {
            ...
            this.soundController.startSound(this.props.warningSoundId);
          }
        } else {
  ...
  public onAfterRender(): void {
    ...
    KeyEventManager.getManager(this.props.bus).then(manager => {
