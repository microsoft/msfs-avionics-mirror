 ...
 */
export class DefaultsPage extends FmcPage {

  public defaultsSettings = DefaultsUserSettings.getManager(this.eventBus);
...
class DefaultsPageTwo extends AbstractDefaultsPage {
  ...
  private readonly climbSpeedSub = CombinedSubject.create(this.climbIasSetting, this.climbMachSetting);
  private readonly cruiseSpeedSub = CombinedSubject.create(this.cruiseIasSetting, this.cruiseMachSetting);
  private readonly descentSpeedSub = CombinedSubject.create(this.descentIasSetting, this.descentMachSetting);
