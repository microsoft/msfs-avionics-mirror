import {
  AdcEvents, ClockEvents, ConsumerSubject, ConsumerValue, EngineEvents, EventBus, GNSSEvents, MappedSubject, Subject, UnitType
} from '@microsoft/msfs-sdk';

import { WT21ControlEvents } from '@microsoft/msfs-wt21-shared';
