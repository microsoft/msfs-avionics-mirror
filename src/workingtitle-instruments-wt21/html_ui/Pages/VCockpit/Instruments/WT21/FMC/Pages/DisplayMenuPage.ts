import { BitFlags, MappedSubject, Subject } from '@microsoft/msfs-sdk';
import { MfdDisplayMode, MFDUpperWindowState, MFDUserSettings } from '../../MFD/MFDUserSettings';
import { MapUserSettings, MapWaypointsDisplay } from '../../Shared/Map/MapUserSettings';
...
import { Formatter } from '../Framework/FmcFormats';
 ...
 * Display Menu
 */
export class DisplayMenu extends FmcPage {
  private readonly mapSettings = MapUserSettings.getMasterManager(this.eventBus);
  ...
  private currentSource: 'PFD' | 'MFD_1' | 'MFD_2' = this.pageManager.fmcIndex === 1 ? 'MFD_1' : 'MFD_2';

  private readonly currentDisplay = Subject.create<number>(0);
  private readonly currentSide = Subject.create<number>(this.pageManager.fmcIndex - 1);
  ...
  protected onInit(): void {
    ...
    this.SideSwitch.takeValue(this.pageManager.fmcIndex - 1);
