...
import { CursorInputSlot } from '../CursorInput';
  ...
  public render(): VNode {
    return (
      <CursorInput
        ...
        allowBackFill={this.props.allowBackFill ?? false}
        canShiftForBackfill={this.props.canShiftForBackfill}
