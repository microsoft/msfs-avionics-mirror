import {
  BitFlags, ConsumerSubject, EventBus, FacilityWaypoint, FacilityWaypointUtils, FlightPathLegRenderPart,
  FlightPathRenderStyle, FlightPathVector, FlightPathVectorStyle, FlightPathWaypoint, FlightPlanDisplayBuilder, ICAO, ImageCache,
...
export const OwnshipIconPath = `${GNSFilePaths.ASSETS_PATH}/Images/ownship.png`;
...
class FlightPathStyles {
   ...
   */
  public static buildWhiteHoldStyles(vector: Readonly<FlightPathVector>, isIngress: boolean): FlightPathRenderStyle {
   ...
   * @returns The appropriate hold leg display style.
   */
  public static buildActiveEntryHoldStyles(vector: Readonly<FlightPathVector>, isIngress: boolean): FlightPathRenderStyle {
