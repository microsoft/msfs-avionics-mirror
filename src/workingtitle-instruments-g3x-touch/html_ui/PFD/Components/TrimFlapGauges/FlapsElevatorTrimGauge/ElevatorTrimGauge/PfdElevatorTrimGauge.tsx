...
import './PfdElevatorTrimGauge.css';

/**
 * Component props for {@link PfdElevatorTrimGauge}.
 */
export interface PfdElevatorTrimGaugeProps extends ComponentProps {
 ...
 */
export class PfdElevatorTrimGauge extends DisplayComponent<PfdElevatorTrimGaugeProps> {
