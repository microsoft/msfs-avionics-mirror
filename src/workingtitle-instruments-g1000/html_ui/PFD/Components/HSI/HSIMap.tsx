...
import { GarminMapKeys, MapRangeController, NavIndicatorController, TrafficAdvisorySystem, TrafficUserSettings, UnitsUserSettings } from '@microsoft/msfs-garminsdk';
