import {
  ActiveLegType, AdcEvents, AdditionalApproachType, AirportFacility, AirwayObject, AltitudeRestrictionType, ApproachProcedure, ApproachUtils, BitFlags,
  ConsumerSubject, ControlEvents, EventBus, ExtendedApproachType, Facility, FacilityLoader, FacilityRepository, FacilityType, FacilityUtils, FixTypeFlags,
  FlightPlan, FlightPlanCalculatedEvent, FlightPlanCopiedEvent, FlightPlanIndicationEvent, FlightPlanLeg, FlightPlanner, FlightPlannerEvents,
  FlightPlanOriginDestEvent, FlightPlanSegment, FlightPlanSegmentType, GeoPoint, GeoPointInterface, GNSSEvents, ICAO, IntersectionFacility,
  LegDefinition, LegDefinitionFlags, LegTurnDirection, LegType, MagVar, NavEvents, NavMath, NavSourceId, NavSourceType, OneWayRunway, RnavTypeFlags,
  RunwayUtils, SmoothingPathCalculator, SpeedRestrictionType, SpeedUnit, Subject, UnitType, UserFacility, VerticalData, VerticalFlightPhase, VerticalFlightPlan,
  VisualFacility, VNavUtils, VorFacility
...
export class WT21Fms {
  ...
  constructor(
    ...
    this.bus.getSubscriber<WT21FmcEvents>().on(FmcMiscEvents.BTN_EXEC).handle(this.onExecButtonPressed);
