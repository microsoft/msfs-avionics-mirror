import {
  ...
  LegDefinition, FlightPlan, ArraySubject, ICAO, ArrivalProcedure, StringUtils, FlightPlanSegmentType,
            ...
            <TouchButton
              ...
              onPressed={async () => {
                ...
                if (selectedFacility && selectedProc) {
                  ...
                  this.gtcService.changePageTo<GtcFlightPlanPage>(GtcViewKeys.FlightPlan).ref.scrollTo(FlightPlanSegmentType.Arrival);
                }
              }}
            />
          </div>
