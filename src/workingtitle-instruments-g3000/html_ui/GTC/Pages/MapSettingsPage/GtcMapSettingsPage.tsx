...
import {
  MapOrientationSettingMode, MapTerrainSettingMode, MapUtils, TerrainSystemStateDataProvider, UnitsUserSettings
} from '@microsoft/msfs-garminsdk';

import {
  AvionicsConfig, ControllableDisplayPaneIndex, DisplayPaneIndex, G3000MapUserSettingTypes, MapInsetSettingMode,
  MapRangeSettingDisplay, MapSettingSync, MapSettingSyncUserSettings, MapUserSettings
