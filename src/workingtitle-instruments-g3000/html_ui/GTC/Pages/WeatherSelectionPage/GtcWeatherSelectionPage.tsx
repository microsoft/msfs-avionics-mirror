    ...
    return (
      <div class='weather-selection'>
        <GtcDesignatedPaneButton
          ...
          label={'Connext\nWeather'}
          imgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_gfds.png`}
          selectedLabel={'Connext\nSettings'}
          selectedImgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_gfds_settings.png`}
        ...
        />
        {
          this.props.hasWeatherRadar && (
            <GtcDesignatedPaneButton
              ...
              label={'WX RADAR'}
              imgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_wx_radar.png`}
              selectedLabel={'WX RADAR\nSettings'}
              selectedImgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_wx_radr_settings.png`}
              onPressed={isSelected => {
                if (isSelected) {
