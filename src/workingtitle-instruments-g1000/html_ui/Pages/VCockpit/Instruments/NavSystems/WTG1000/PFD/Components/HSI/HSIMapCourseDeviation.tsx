import { ComponentProps, DisplayComponent, FSComponent, NavMath, NavSourceType, Subject, VNode, VorToFrom } from 'msfssdk';

import { NavIndicatorController, NavSensitivity, ObsSuspModes } from 'garminsdk';
