import { FSComponent, HorizonLayer, HorizonLayerProps, ObjectSubject, Subscribable, Subscription, VNode } from 'msfssdk';
...
export class AttitudeAircraftSymbol extends HorizonLayer<AttitudeAircraftSymbolProps> {
  ...
  public render(): VNode {
    return (
      <svg viewBox='0 0 414 315' class='attitude-aircraft-symbol' style={this.style}>
        <path
