...
import { MemButtonState, MfdDisplayMode, MFDSettingsAliased, MFDUpperWindowState, MFDUserSettings } from '../MFDUserSettings';
import { CcpControlEvents, EngineIndicationDisplayMode } from './CcpControlEvents';
...
export class CcpController {
  ...
  private readonly mfdSettingManager = MFDUserSettings.getAliasedManager(this.bus);

  // eslint-disable-next-line jsdoc/require-jsdoc
  public constructor(
    private readonly bus: EventBus,
    private readonly mapSettingsManager = MapUserSettings.getAliasedManager(bus, 'MFD'),
