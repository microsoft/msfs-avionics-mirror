import { DebounceTimer, DisplayComponent, FSComponent, Subject, Subscribable, Subscription, VNode } from '@microsoft/msfs-sdk';
...
export class DigitInput extends G1000UiControl<DigitInputProps> {
  ...
  protected changeValue(delta: number): void {
    ...
    if (this.wrap.get()) {
      ...
      newValue = Utils.Clamp(old + delta, min, max);
    }
