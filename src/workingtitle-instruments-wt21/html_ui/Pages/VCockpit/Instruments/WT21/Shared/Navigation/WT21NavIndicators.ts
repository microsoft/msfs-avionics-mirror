...
import { DcpEvent } from '../../PFD/DCP/DcpEvent';
import { DcpEventPublisherType } from '../../PFD/DCP/DcpEventPublisher';
...
export class WT21CourseNeedleNavIndicator extends NavIndicator<WT21NavSourceNames> {
  ...
  public constructor(navSources: WT21NavSources, private readonly bus: EventBus, private readonly pfdOrMfd: 'PFD' | 'MFD') {
    ...
    const dcpEvents = bus.getSubscriber<DcpEventPublisherType>();
  ...
  private readonly presetIncrease = (): void => {
  ...
  private readonly presetDecrease = (): void => {
    this.standbySourceIndex--;
