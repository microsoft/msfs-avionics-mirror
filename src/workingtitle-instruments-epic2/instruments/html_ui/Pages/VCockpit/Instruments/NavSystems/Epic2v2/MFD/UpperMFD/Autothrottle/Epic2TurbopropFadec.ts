import { AutothrottleThrottleIndex, EventBus, GameStateProvider, ThrottleLeverManager, TurbopropFadec, Wait } from '@microsoft/msfs-sdk';
 ...
 */
export class Epic2TurbopropFadec extends TurbopropFadec implements Epic2Fadec {
  ...
  public readonly throttleLeverManager = new ThrottleLeverManager(
    ...
    () => {
      ...
      if (this.isGameStateInit) {
        this.start(Epic2TurbopropFadec.UPDATE_FREQ);
      }
    },
    {
  ...
  public get engineType(): Epic2EngineType {
    return Epic2EngineType.Turboprop;
  }
