import {
  ComponentProps, DisplayComponent, FacilityLoader, FacilitySearchType, FacilityWaypoint, FSComponent, GeoPoint, GeoPointSubject,
  MappedSubject, SearchTypeMap, SetSubject, Subject, Subscribable, SubscribableUtils, Subscription, UserSettingManager, VNode
...
export abstract class GtcWaypointInfoPage<T extends WaypointSelectType, P extends GtcWaypointInfoPageProps = GtcWaypointInfoPageProps> extends GtcView<P> {
  ...
  protected readonly showOnMapData = Subject.create<Omit<WaypointInfoPaneSelectionData, 'resetRange'>>(
    ...
    (a, b) => {
      ...
      return a.icao === b.icao && a.runwayIndex === b.runwayIndex;
    }
  );
   ...
   */
  public abstract initSelection(facility?: SearchTypeMap[T] | string): Promise<void>;
