import { WeatherRadarOperatingMode } from 'garminsdk';
import { AdcEvents, CombinedSubject, ConsumerSubject, FSComponent, VNode } from 'msfssdk';
...
export class MFDWeatherRadarModeMenu extends SoftKeyMenu {
  ...
  /** @inheritdoc */
  constructor(menuSystem: MenuSystem, private readonly viewService: ViewService) {
    super(menuSystem);
