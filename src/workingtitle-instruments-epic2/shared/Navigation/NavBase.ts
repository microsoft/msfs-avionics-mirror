...
export class NavBaseFields {
  ...
  public readonly isDmeHoldActive = Subject.create<boolean | null>(null);
...
export type NavBaseControlEvents<Prefix extends string, T extends { [key: string]: any }, DuIndex extends DisplayUnitIndices> = {
