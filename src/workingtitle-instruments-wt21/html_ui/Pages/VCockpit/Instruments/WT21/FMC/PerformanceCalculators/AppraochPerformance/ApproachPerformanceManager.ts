...
import { BasePerformanceDataManager } from '../BasePerformanceDataManager';

/**
 * Results of approach performance calculations
 */
...
export class ApproachPerformanceManager {
  ...
  constructor(
    ...
    private readonly performancePlan: PerformancePlanData,
