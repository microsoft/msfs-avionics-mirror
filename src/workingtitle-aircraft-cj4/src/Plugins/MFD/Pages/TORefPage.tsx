...
import { WT21MfdApprPerfOutputs, WT21MfdTextPageEvents, WT21MfdToPerfOutputs, WT21UnitsUtils } from '@microsoft/msfs-wt21-shared';

import { MfdTextPageComponent, MfdTextPageProps } from '@microsoft/msfs-wt21-mfd';

import { CJ4PerformancePlan } from '../../Shared/Performance/CJ4PerformancePlan';

import './PerfReferencePage.css';
...
export interface TORefPageProps extends MfdTextPageProps {
   ...
   * A performance plan
   */
  performancePlan: CJ4PerformancePlan,
}
