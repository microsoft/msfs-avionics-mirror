import {
  AdcEvents, ArrayUtils, ConsumerValue, FSComponent, MappedSubject, MappedSubscribable, MathUtils, Subject,
  Subscription, UserSetting, UserSettingManager, VNode
} from '@microsoft/msfs-sdk';

import { WeatherRadarOperatingMode, WeatherRadarScanMode, WeatherRadarUserSettingTypes } from '@microsoft/msfs-garminsdk';

import {
  ControllableDisplayPaneIndex, G3000FilePaths, WeatherRadarDefinition, WeatherRadarEvents, WeatherRadarUserSettings
    ...
    return (
      <div class='weather-radar-settings'>
        ...
        <div class='weather-radar-settings-gain'>
          ...
          >
            <img src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_volume_plus_up.png`} />
          </TouchButton>
          <TouchSlider
            bus={this.bus}
            orientation='to-top'
          ...
          <TouchButton
            ...
            onPressed={this.incrementGain.bind(this, -1)}
          >
            <img src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_volume_minus_down.png`} />
          </TouchButton>
        </div>
      </div>
    );
