...
import { DisplayUnitConfigInterface, DisplayUnitLayout } from '../../Shared/Config/DisplayUnitConfig';
...
import { MFDUpperWindowState, MFDUserSettings } from '../MFDUserSettings';
...
export class MfdLwrMenuViewService extends MenuViewService<MfdLwrMenuViewKeys> {
  ...
  private readonly mfdSoftkeyFormatChangeActiveSetting = this.userSettingsManagerMfd.getSetting('mfdSoftkeyFormatChangeActive');
  ...
  private mfdSoftkeyFormatChangeActiveTimeout: NodeJS.Timer | undefined = undefined;
          ...
          if (evt !== undefined) {
            ...
            switch (evt) {
              case GuiHEvent.SOFTKEY_1L: {
                ...
                this.mfdSoftkeyFormatChangeActiveTimeout = setTimeout(() => this.mfdSoftkeyFormatChangeActiveSetting.set(false), 10_000);

                if (!this.mfdSoftkeyFormatChangeActiveSetting.get()) {
                  this.mfdSoftkeyFormatChangeActiveSetting.set(true);
                  return true;
                }
