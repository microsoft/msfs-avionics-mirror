...
export class DisplayPane extends DisplayComponent<DisplayPaneProps> {
  ...
  public readonly activeView = this.activeViewEntry.map(entry => entry?.view) as Subscribable<DisplayPaneView | null>;
  ...
  public update(time: number): void {
    if (this.props.sizeMode.get() !== DisplayPaneSizeMode.Hidden) {
      this.activeViewEntry.get()?.view.onUpdate(time);
    }
  }
   ...
   */
  private resumeView(entry: ViewEntry): void {
    const sizeMode = this.props.sizeMode.get();
   ...
   */
  private pauseView(entry: ViewEntry): void {
