...
interface PfdMsgInfoProps extends ComponentProps {
  // eslint-disable-next-line jsdoc/require-jsdoc
  bus: EventBus;
  // eslint-disable-next-line jsdoc/require-jsdoc
...
export class WT21_PFD_MsgInfo extends DisplayComponent<PfdMsgInfoProps> {
  ...
  public readonly handleMessages = (messagePacket: PfdMessagePacket): void => {
    ...
    if (this.props.instrumentType === WT21InstrumentType.Pfd) {
      ...
      const fmcMsgLevel = SimVar.GetSimVarValue('L:WT21_DISPLAY_MSG', 'number') as MESSAGE_LEVEL | -1;
