...
export class G3000BacklightPublisher extends SimVarPublisher<G3000BacklightEvents, G3000BacklightIndexedEventsRoot> {
  ...
  public constructor(bus: EventBus, pacer?: PublishPacer<G3000BacklightEvents>) {
    super(new Map([
      ['g3000_backlight_pfd', { name: 'L:1:WTG3000_Pfd_Backlight_#index#', type: SimVarValueType.Number, indexed: [1, 2], defaultIndex: null }],
      ['g3000_backlight_mfd', { name: 'L:1:WTG3000_Mfd_Backlight_#index#', type: SimVarValueType.Number, indexed: [1] }],
      ['g3000_backlight_gtc', { name: 'L:1:WTG3000_Gtc_Backlight_#index#', type: SimVarValueType.Number, indexed: true, defaultIndex: null }],
      ['g3000_backlight_auto_level', { name: 'L:1:WTG3000_Auto_Backlight', type: SimVarValueType.Number }]
    ]), bus, pacer);
  }
}
...
export class G3000BacklightUtils {
  ...
  public static getPfdLevelSimVarName(index: PfdIndex): string {
    ...
    return index === 1 ? 'L:1:WTG3000_Pfd_Backlight_1' : 'L:1:WTG3000_Pfd_Backlight_2';
  }
  ...
  public static getMfdLevelSimVarName(): string {
    return 'L:1:WTG3000_Mfd_Backlight_1';
  }
  ...
  public static getGtcLevelSimVarName(index: number): string {
    ...
    return `L:1:WTG3000_Gtc_Backlight_${index}`;
  }
  ...
  public static getAutoLevelSimVarName(): string {
    return 'L:1:WTG3000_Auto_Backlight';
  }
}
