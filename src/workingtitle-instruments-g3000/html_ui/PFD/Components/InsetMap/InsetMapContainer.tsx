...
import {
  DisplayPaneSizeMode, DisplayPaneViewEvent, G3000FlightPlannerId, MapConfig, PfdIndex, PfdMapLayoutSettingMode,
...
export class InsetMapContainer extends DisplayComponent<InsetMapContainerProps> {
  ...
  public onInteractionEvent(event: string): boolean {
    return this.activeMap?.onInteractionEvent(event) ?? false;
  }
