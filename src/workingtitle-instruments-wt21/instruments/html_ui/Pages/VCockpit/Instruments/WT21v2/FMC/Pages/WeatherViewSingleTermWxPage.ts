import { DisplayField, FmcPageLifecyclePolicy, FmcRenderTemplate, ICAO, PageLinkField, RawFormatter } from '@microsoft/msfs-sdk';
 ...
 */
export class WeatherViewSingleTermWxPage extends WT21FmcPage {
  ...
  onInit(): void {
    ...
    const idx = this.params.get('index') as number;
