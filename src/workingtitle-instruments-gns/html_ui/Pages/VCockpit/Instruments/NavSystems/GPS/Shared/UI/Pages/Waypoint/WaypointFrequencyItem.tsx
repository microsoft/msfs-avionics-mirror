 ...
 */
export class WaypointFrequencyItem extends GNSUiControl<WaypointFrequencyItemProps> {
...
export interface WaypointFrequencyItemProps extends GNSUiControlProps {
