import {
  AdcEvents, APEvents, APLockType, ApproachGuidanceMode, EventBus, SoundServerControlEvents, Subject, VNavEvents, VNavPathMode
...
/**
 * Events for the altitude alert state.
 */
export interface AltitudeAlertStateEvents {
  /** The state of the altitude alerter. */
  altitude_alert_state: AltAlertState;
}
...
export class AltitudeAlertController {
  ...
  private readonly alertPub = this.bus.getPublisher<AltitudeAlertStateEvents>();
  /**
  ...
  constructor(private bus: EventBus) {
    ...
    this.alerterState.sub((v: AltAlertState): void => {
      this.alertPub.pub('altitude_alert_state', v);
