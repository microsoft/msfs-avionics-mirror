...
import { GtcTextDialog } from '../../Dialog/GtcTextDialog';
        ...
        <div class='flight-plan-options-row'>
          ...
          <TouchButton
            ...
            onPressed={async (): Promise<void> => {
              const result = await this.props.gtcService.openPopup<GtcTextDialog>(
                GtcViewKeys.TextDialog, 'normal', 'hide').ref.request({
                  label: 'Route Comment',
                  allowSpaces: true,
                  maxLength: 20,
                });
