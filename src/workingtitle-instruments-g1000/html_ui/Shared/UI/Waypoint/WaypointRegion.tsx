import { AirportFacility, ComputedSubject, FacilityWaypointUtils, FSComponent, ICAO, VNode, Waypoint } from '@microsoft/msfs-sdk';

import { AirportWaypoint, Regions, WaypointComponentProps, WaypointComponent } from '@microsoft/msfs-garminsdk';
