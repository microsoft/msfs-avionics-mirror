import { ControlPublisher, EventBus } from '@microsoft/msfs-sdk';
...
export class PFDOptMenu extends SoftKeyMenu {
   ...
   */
  constructor(menuSystem: SoftKeyMenuSystem, publisher: ControlPublisher, g1000Publisher: G1000ControlPublisher, bus: EventBus) {
    super(menuSystem);
