import {
  ComponentProps, DisplayComponent, FSComponent, MappedSubject, MathUtils, ObjectSubject, SetSubject, Subject,
  Subscribable, SubscribableMapFunctions, SubscribableSet, Subscription, VNode
...
export class VerticalDeviationIndicator extends DisplayComponent<VerticalDeviationIndicatorProps> {
  ...
  public render(): VNode {
    return (
      <div class={this.rootCssClass} style={this.rootStyle} data-checklist='checklist-vdi'>
        ...
        <div class='vdi-scale'>
          ...
          >
            <circle cx={0} cy={0} r={4.5} vector-effect='non-scaling-stroke' />
          </svg>
          <svg
            viewBox='-4.5 -4.5 9 9'
            class='vdi-scale-dot'
          ...
          <div class='vdi-bug-container' style='position: absolute; left: 0; top: 0; width: 100%; height: 100%; overflow: hidden;'>
            <VerticalDeviationBug
              ...
              class='vdi-gs-bug'
            >
              <svg viewBox='0 0 16 16' class='vdi-gs-bug-icon'>
            ...
            <VerticalDeviationBug
              ...
              class='vdi-gp-bug'
            >
              <svg viewBox='0 0 16 16' class='vdi-gp-bug-icon'>
                <path d='M 0 8 l 8 -8 l 8 8 l -8 8 Z' vector-effect='non-scaling-stroke' />
              </svg>
            </VerticalDeviationBug>
            ...
            <VerticalDeviationBug
              ...
              class='vdi-vnav-bug'
            >
              <svg viewBox='0 0 16 24' class='vdi-vnav-bug-icon'>
                <path d='M 0 12 l 16 -12 l 0 4 l -10.67 8 l 10.67 8 l 0 4 Z' vector-effect='non-scaling-stroke' />
              </svg>
            </VerticalDeviationBug>
          </div>
