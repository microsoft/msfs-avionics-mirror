import { MappedSubject, UnitType } from '@microsoft/msfs-sdk';
...
import { AltitudeInputFormat, ConvertableNumberAndUnitFormat, Formatter, SimpleStringFormat, Validator } from '../Framework/FmcFormats';
 ...
 * Perf Init page
 */
export class PerfInitPage extends FmcPage {
  ...
  private readonly takeoffLink = PageLinkField.createLink(this, 'TAKEOFF>', '/takeoff-ref');
