import { AdcEvents, APEvents, APLockType, ComputedSubject, DisplayComponent, EventBus, FSComponent, MathUtils, Subject, VNavEvents, VNode } from '@microsoft/msfs-sdk';

import { GPDisplayMode, NavIndicatorController, VNavDisplayMode } from '@microsoft/msfs-garminsdk';
