...
import {
  FSComponent, MapDataIntegrityModule, MapSystemBuilder, MapSystemContext, MapSystemKeys, MappedSubscribable, NumberFormatter,
  NumberUnitInterface, Subject, Subscribable, TcasOperatingMode, Unit, UnitFamily, UserSettingManager, VNode, Vec2Math
} from '@microsoft/msfs-sdk';

import {
  DefaultFlightPathPlanRenderer, GarminMapBuilder, GarminMapKeys, MapOrientation, MapOrientationIndicator,
  MapOrientationModule, MapTrafficAltitudeRestrictionMode, TrafficIconOptions, TrafficMapAltitudeModeIndicator,
...
import { G3XMapTrafficStatusIndicator, G3XTrafficMapOperatingModeIndicator, TrafficMapCombinedIndicator, TrafficMapRangeControlIndicator, TrafficMapRangeControlIndicatorControllers } from '../Indicators';
