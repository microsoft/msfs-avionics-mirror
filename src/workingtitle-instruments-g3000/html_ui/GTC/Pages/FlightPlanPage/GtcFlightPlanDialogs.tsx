...
import { FlightPlanListManager, FlightPlanStore, G3000FilePaths } from '@microsoft/msfs-wtg3000-common';
...
export class GtcFlightPlanDialogs {
  ...
  public static async activateLegToWaypoint(
    ...
    const arrow = (
      <img src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/wt_magenta_activate_leg_arrow.png`} />
    );
