import { ClockEvents, ComputedSubject, ConsumerSubject, Subject } from '@microsoft/msfs-sdk';
...
import { Formatter, RawFormatter, TimeFormatter } from '../Framework/FmcFormats';
...
/** STATUS page */
export class StatusPage extends FmcPage {
    ...
    public init(): void {
        ...
        this.addBinding(new Binding<boolean>(this.isNavDbValid, (isValid: boolean): void => {
            this.NavDbDateField.getOptions().style = isValid ? '' : '[yellow]';
            this.invalidate();
        }));
        this.addBinding(new Binding<Date>(this.SimTimeConsumer, (value: Date) => {
