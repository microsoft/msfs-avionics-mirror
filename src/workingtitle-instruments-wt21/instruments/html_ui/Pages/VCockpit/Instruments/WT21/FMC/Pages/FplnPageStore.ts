import { ArraySubject, EventBus, FlightPlanSegmentType, LegDefinition, Subject, SubscribableArray } from '@microsoft/msfs-sdk';
...
export class FplnPageStore {
  ...
  public readonly flightNoSetting = FmcUserSettings.getManager(this.bus).getSetting('flightNumber');
