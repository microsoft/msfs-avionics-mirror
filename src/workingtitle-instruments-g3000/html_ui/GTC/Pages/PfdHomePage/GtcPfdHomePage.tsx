      ...
      <div class="pfd-home">
        <div class="pfd-home-row pfd-home-top-row">
          ...
          <div class="pfd-home-top-row-column">
            ...
            >
              <img src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_obs.png`} />
            </ToggleTouchButton>
            <ValueTouchButton
        ...
        <div class="pfd-home-row">
          ...
          <ImgTouchButton
            label="Minimums"
            imgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_minimums.png`}
        ...
        <div class="pfd-home-row">
          <ImgTouchButton
            ...
            imgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_inset_map_settings.png`}
            onPressed={() => this.props.gtcService.changePageTo(GtcViewKeys.PfdMapSettings)}
            class="gtc-directory-button"
          />
          <ImgTouchButton
            label="Sensors"
            imgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_sensors.png`}
            isEnabled={false}
            class="gtc-directory-button"
          />
          <ImgTouchButton
            label="PFD<br>Settings"
            imgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_pfd_settings.png`}
