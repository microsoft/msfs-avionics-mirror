import { APLateralModes, APModeType, APStateManager, APVerticalModes, ControlEvents, KeyEventData, KeyEventManager, NavSourceType } from '@microsoft/msfs-sdk';

/**
 * A WT21 autopilot state manager.
 */
export class WT21APStateManager extends APStateManager {
