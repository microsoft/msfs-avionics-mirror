...
export class Sr22tReversionarySecondaryEngineData extends DisplayComponent<Sr22tReversionarySecondaryEngineDataProps> {
  ...
  public onAfterRender(): void {
    this.subs = [
      ...
      this.sub.on('elec_bat_load_1').handle((v) => this.battery1Subject.set(v)),
      this.sub.on('elec_bus_genalt_a_1').handle((v) => this.alt1.set(v)),
      this.sub.on('elec_bus_genalt_a_2').handle((v) => this.alt2.set(v)),
