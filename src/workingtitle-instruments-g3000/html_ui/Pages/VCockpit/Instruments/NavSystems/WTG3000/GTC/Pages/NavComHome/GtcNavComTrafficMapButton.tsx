...
import { DisplayPaneSettings, DisplayPaneViewKeys, PfdMapLayoutSettingMode, PfdMapLayoutUserSettingTypes, ToggleStatusBar } from '@microsoft/msfs-wtg3000-common';

import { BtnImagePath, BtnImagePathVert } from '../../ButtonBackgroundImagePaths';
  ...
  public render(): VNode {
    ...
    return (
      <BgImgTouchButton
        ...
        upImgSrc={BtnImagePathVert.TrafficUp}
        downImgSrc={BtnImagePathVert.TrafficDown}
      ...
      >
        <img
          class='gtc-nav-com-traffic-map-button-img'
          src={BtnImagePath.TrafficMap}></img>
        <ToggleStatusBar
