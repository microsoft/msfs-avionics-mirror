...
import {
  ...
  FmsSpeedTargetSource, FmsSpeedValue, FpaDisplay, LegNameDisplay, VnavProfileStore
          ...
          <div class='advanced-vnav-profile-tab-fms-speed-cell'>
            ...
            >
              ...
              <div class='advanced-vnav-profile-tab-fms-speed-user-button-value-row'>
                ...
                />
                <img src='coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_pencil.png' class={this.userSpeedPencilCssClass} />
              </div>
            </GtcTouchButton>
            <GtcTouchButton
              onPressed={() => {
