...
import {
  GuiDialog, GuiDialogProps, MapUserSettings, PopupMenuSection, PopupSubMenu, RadioBox, RadioList, WT21InstrumentType
...
export class PfdOverlaysMenu extends GuiDialog<PfdOverlaysMenuProps> {
  ...
  private readonly mapSettingsManager = MapUserSettings.getAliasedManager(this.props.bus, WT21InstrumentType.Pfd, this.props.instrumentIndex);
