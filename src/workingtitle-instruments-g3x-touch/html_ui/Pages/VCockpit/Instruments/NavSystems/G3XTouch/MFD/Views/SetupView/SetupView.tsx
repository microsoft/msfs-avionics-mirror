  ...
  private renderButtons(): VNode[] {
    ...
    return [
      ...
      <UiImgTouchButton
        ...
        isEnabled={false}
        class='ui-directory-button'
        imgSrc={`${G3XTouchFilePaths.ASSETS_PATH}/Images/icon_position.png`}
      />,
      <UiImgTouchButton
        label='Alarms'
        isEnabled={false}
        class='ui-directory-button'
        imgSrc={`${G3XTouchFilePaths.ASSETS_PATH}/Images/icon_alarm.png`}
      />,
      <UiImgTouchButton
        label='Airspace'
        isEnabled={false}
        class='ui-directory-button'
        imgSrc={`${G3XTouchFilePaths.ASSETS_PATH}/Images/icon_airspace.png`}
      />,
      <UiImgTouchButton
        label='Bluetooth'
        isEnabled={false}
        class='ui-directory-button'
        imgSrc={`${G3XTouchFilePaths.ASSETS_PATH}/Images/icon_bluetooth.png`}
      />,
      <UiImgTouchButton
        label='PFD'
      ...
      <UiImgTouchButton
        ...
        isEnabled={false}
        class='ui-directory-button'
        imgSrc={`${G3XTouchFilePaths.ASSETS_PATH}/Images/icon_autopilot.png`}
      />,
      <UiImgTouchButton
        label={'Flight\nDirector'}
        isEnabled={false}
        class='ui-directory-button'
        imgSrc={`${G3XTouchFilePaths.ASSETS_PATH}/Images/icon_flight_director.png`}
      />,
      <UiImgTouchButton
        label='Trim'
        isEnabled={false}
        class='ui-directory-button'
        imgSrc={`${G3XTouchFilePaths.ASSETS_PATH}/Images/icon_trim.png`}
      />,
      <UiImgTouchButton
        label='Navigation'
        isEnabled={false}
        class='ui-directory-button'
        imgSrc={`${G3XTouchFilePaths.ASSETS_PATH}/Images/icon_navigation.png`}
      />,
      <UiImgTouchButton
        label='Keyboard'
        isEnabled={false}
        class='ui-directory-button'
        imgSrc={`${G3XTouchFilePaths.ASSETS_PATH}/Images/icon_keyboard.png`}
      />,
    ];
  }
