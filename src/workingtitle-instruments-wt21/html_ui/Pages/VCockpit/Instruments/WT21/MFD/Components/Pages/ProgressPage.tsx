import {
  ...
  FacilityLoader, FacilityType, FlightPlanner, FlightPlanPredictor, FSComponent, MappedSubject, NumberFormatter, Subject, Subscribable,
  UnitType, VNavEvents, VNode,
...
export class ProgressPage extends MfdTextPageComponent<ProgressPageProps> {
  ...
  private update(): void {
    ...
    if (this.props.planner.hasFlightPlan(WT21Fms.PRIMARY_ACT_PLAN_INDEX)) {
      plan = this.props.planner.getFlightPlan(WT21Fms.PRIMARY_ACT_PLAN_INDEX);
    }
