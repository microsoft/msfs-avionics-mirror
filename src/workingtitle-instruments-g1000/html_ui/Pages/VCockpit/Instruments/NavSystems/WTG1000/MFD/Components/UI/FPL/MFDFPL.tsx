import { EventBus, FacilityLoader, FacilityRepository, FocusPosition, FSComponent, Subject, VNode } from '@microsoft/msfs-sdk';
    ...
    return (
      <div class='mfd-fpl mfd-dark-background wide'>
        ...
        <GroupBox title="Active VNV Profile">
          <MFDFPLVNavProfile ref={this.vnavProfileRef} bus={this.props.bus} flightPlanner={this.props.fms.flightPlanner} fms={this.props.fms} />
        </GroupBox>
