import {
  ComponentProps, DisplayComponent, EventBus, FSComponent, ReadonlyFloat64Array, Subject, Subscribable, SubscribableUtils, Vec2Math, Vec2Subject, VNode
} from '@microsoft/msfs-sdk';

import { TouchList } from './TouchList';

/**
 * Component props for Epic2TouchList.
 */
export interface Epic2TouchListProps extends ComponentProps {
  /** The event bus. */
  bus: EventBus,
 ...
 */
export class Epic2TouchList extends DisplayComponent<Epic2TouchListProps> {
  private readonly listRef = FSComponent.createRef<TouchList>();
