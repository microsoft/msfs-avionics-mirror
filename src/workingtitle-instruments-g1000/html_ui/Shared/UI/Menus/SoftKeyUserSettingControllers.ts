...
export class SoftKeyBooleanUserSettingController<T extends UserSettingRecord, K extends keyof UserSettingValueFilter<T, boolean> & string> {
  ...
  public init(): void {
    ...
    this.settingSub = (this.settingManager.getSetting(this.settingName) as UserSetting<boolean>).sub(this.settingHandler, true);
...
export class SoftKeyEnumUserSettingController<T extends UserSettingRecord, K extends keyof T & string> {
  ...
  public init(): void {
    ...
    this.settingSub = this.settingManager.getSetting(this.settingName).sub(this.settingHandler, true);
