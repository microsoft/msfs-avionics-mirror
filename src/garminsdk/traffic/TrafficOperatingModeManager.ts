import { AdcEvents, ConsumerSubject, DebounceTimer, EventBus, Subscription } from '@microsoft/msfs-sdk';
...
export class TrafficOperatingModeManager {
  ...
  public constructor(
    ...
    private readonly operatingMode = TrafficOperatingModeSetting.Operating
  ) {
  }
