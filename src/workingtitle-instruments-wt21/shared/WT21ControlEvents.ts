...
/** Extension of generic ControlEvents to handle WT21-specific events. */
export interface WT21ControlEvents {
  ...
  /** Indicates if a softkey format change is active on MFD 1 */
  softkeyFormatChangeActive_1: boolean;

  /** Indicates if a softkey format change is active on MFD 1 */
  softkeyFormatChangeActive_2: boolean;
}
