import { APEvents, ClockEvents, ConsumerSubject, ConsumerValue, EventBus, ExpSmoother, Subject, Subscribable } from '@microsoft/msfs-sdk';
...
export class DefaultFlightDirectorDataProvider implements FlightDirectorDataProvider {
  ...
  public init(paused = false): void {
    ...
    const sub = this.bus.getSubscriber<APEvents & ClockEvents>();
