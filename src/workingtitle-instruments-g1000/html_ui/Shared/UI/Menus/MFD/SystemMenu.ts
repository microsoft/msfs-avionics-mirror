import { XMLExtendedGaugeConfig } from '@microsoft/msfs-sdk';
...
export class SystemMenu extends SoftKeyMenu {
   ...
   */
  constructor(menuSystem: SoftKeyMenuSystem, config: XMLExtendedGaugeConfig, publisher: G1000ControlPublisher) {
    super(menuSystem);
