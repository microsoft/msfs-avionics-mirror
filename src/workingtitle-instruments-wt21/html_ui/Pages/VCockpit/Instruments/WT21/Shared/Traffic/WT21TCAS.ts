import { DefaultTcasIntruder, EventBus, MappedSubject, Tcas, TcasIISensitivity, TcasOperatingMode, TrafficContact, TrafficInstrument, UnitType } from '@microsoft/msfs-sdk';
