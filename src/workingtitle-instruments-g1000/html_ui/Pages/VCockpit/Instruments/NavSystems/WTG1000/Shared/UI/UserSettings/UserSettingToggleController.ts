import { Subject, UserSettingManager, UserSettingRecord } from 'msfssdk';
 ...
 */
export class UserSettingToggleController<T extends UserSettingRecord, K extends keyof T & string> extends UserSettingController<T, K> {
  /**
