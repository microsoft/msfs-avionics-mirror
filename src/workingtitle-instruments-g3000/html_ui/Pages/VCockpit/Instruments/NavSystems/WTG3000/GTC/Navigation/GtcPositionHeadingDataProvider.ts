 ...
 */
export class GtcDefaultPositionHeadingDataProvider implements GtcPositionHeadingDataProvider {
  ...
  public init(paused = false): void {
    if (!this.isAlive) {
      throw new Error('GtcDefaultPositionHeadingDataProvider: cannot initialize a dead provider');
    }
  ...
  public resume(): void {
    if (!this.isAlive) {
      throw new Error('GtcDefaultPositionHeadingDataProvider: cannot resume a dead provider');
    }
  ...
  public pause(): void {
    if (!this.isAlive) {
      throw new Error('GtcDefaultPositionHeadingDataProvider: cannot pause a dead provider');
    }
