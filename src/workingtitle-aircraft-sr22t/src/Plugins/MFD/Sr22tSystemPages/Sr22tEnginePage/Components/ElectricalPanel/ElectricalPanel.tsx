...
export class ElectricalPanel extends DisplayComponent<ElectricalPanelProps> {
  ...
  private alt1Subject = ConsumerSubject.create(this.props.bus.getSubscriber<ElectricalEvents>().on('elec_bus_genalt_1_a').withPrecision(0), 0);   // Amps
  private alt2Subject = ConsumerSubject.create(this.props.bus.getSubscriber<ElectricalEvents>().on('elec_bus_genalt_2_a').withPrecision(0), 0);   // Amps
