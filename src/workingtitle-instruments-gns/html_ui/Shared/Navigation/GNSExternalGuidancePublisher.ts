...
export class GNSExternalGuidancePublisher {
  ...
  public constructor(private readonly index: number) {
    ...
    for (const simVar of Object.values(APExternalGpsSteerCommandSimVars)) {
      this.simVarNames[simVar] = `${simVar}_${index}`;
    }
  ...
  private initVars(): void {
    ...
    SimVar.SetSimVarValue(this.simVarNames[APExternalGpsSteerCommandSimVars.IsHeading], SimVarValueType.Bool, 0);
    SimVar.SetSimVarValue(this.simVarNames[APExternalGpsSteerCommandSimVars.CourseToSteer], SimVarValueType.Degree, 0);
    SimVar.SetSimVarValue(this.simVarNames[APExternalGpsSteerCommandSimVars.TrackRadius], SimVarValueType.Number, 0);
  ...
  private updateLnavVars(steerCommand: Accessible<Readonly<APGpsSteerDirectorSteerCommand>>): void {
    ...
    SimVar.SetSimVarValue(this.simVarNames[APExternalGpsSteerCommandSimVars.IsHeading], SimVarValueType.Bool, lnav.isHeading);
    SimVar.SetSimVarValue(this.simVarNames[APExternalGpsSteerCommandSimVars.CourseToSteer], SimVarValueType.Degree, lnav.courseToSteer);
    SimVar.SetSimVarValue(this.simVarNames[APExternalGpsSteerCommandSimVars.TrackRadius], SimVarValueType.Number, lnav.trackRadius);
