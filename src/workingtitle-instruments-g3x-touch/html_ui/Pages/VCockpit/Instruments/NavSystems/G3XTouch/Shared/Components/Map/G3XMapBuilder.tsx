...
import {
  GarminAirspaceShowTypeMap, GarminMapBuilder, GarminMapKeys, MapAirspaceVisUserSettings, MapDeclutterMode,
  MapNexradModule, MapOrientation, MapOrientationSettingsControllerSettings, MapPanningModule, MapPanningRTRController,
  MapPanningRTRControllerContext, MapPanningRTRControllerModules, MapSymbolVisController,
  MapSymbolVisControllerModules, MapWaypointDisplayBuilder, MapWaypointVisUserSettings, MapWaypointsModule,
  MapWxrController, MapWxrControllerModules
 ...
 */
export type CompassArcOptions = Omit<G3XMapCompassArcLayerProps, keyof MapLayerProps<any>>;

/**
 * Options for the track vector.
 */
export type TrackVectorOptions = Omit<G3XMapTrackVectorLayerProps, keyof MapLayerProps<any>>;
...
export class G3XMapBuilder {
  ...
  >(
    mapBuilder: MapBuilder,
    options: Readonly<CompassArcOptions>,
    order?: number
  ): MapBuilder {
    return mapBuilder
  ...
  public static waypoints<MapBuilder extends MapSystemBuilder>(
    ...
    mapBuilder
      ...
      .with(GarminMapBuilder.waypoints, configure, supportRunwayOutlines, undefined, order);
