import {
  ActiveOrUpcomingLegPredictions, ClockEvents, ComponentProps, ComputedSubject, ConsumerSubject, DateTimeFormatter, DisplayComponent, DmsFormatter,
  DurationFormatter, EngineEvents, EventBus, FacilityLoader, FacilityType, FlightPlanner, FlightPlannerEvents, FlightPlanPredictor, FSComponent, ICAO,
  MappedSubject, NumberFormatter, PassedLegPredictions, Subject, Subscribable, UnitType, VNode
...
import { PerformancePlanData, WT21LNavDataEvents, WT21FmsUtils, WT21UnitsUtils } from '@microsoft/msfs-wt21-shared';
