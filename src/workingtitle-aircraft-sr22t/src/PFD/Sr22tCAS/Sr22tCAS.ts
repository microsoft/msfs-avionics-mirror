...
export class Sr22tCAS {
  ...
  private readonly sourceData = {
    ...
    // Electrical
    alt1Amps: ConsumerSubject.create(this.subscriber.on('elec_bus_genalt_a_1').withPrecision(1), 0),   // Amps
    alt2Amps: ConsumerSubject.create(this.subscriber.on('elec_bus_genalt_a_2').withPrecision(1), 0),   // Amps
    ...
    avionicsOn: ConsumerSubject.create(this.subscriber.on('elec_circuit_avionics_on_1'), false),
