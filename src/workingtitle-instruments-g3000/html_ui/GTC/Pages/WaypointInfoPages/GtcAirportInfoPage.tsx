...
import {
  AirportWaypoint, ApproachListItem, ComRadioSpacingSettingMode, ComRadioUserSettings, DirectToState, Fms, FmsUtils,
  LatLonDisplayFormat, ProcedureType, UnitsUserSettingManager, WaypointInfoStore
} from '@microsoft/msfs-garminsdk';

import {
  ApproachNameDisplay, BearingDisplay, DynamicList, DynamicListData, FlightPlanStore, G3000FmsUtils,
  G3000NearestContext, GarminLatLonDisplay, NumberUnitDisplay
...
export class GtcAirportInfoPage extends GtcWaypointInfoPage<FacilitySearchType.Airport, GtcAirportInfoPageProps> {
  ...
  public async initSelection(facility?: AirportFacility | IcaoValue): Promise<void> {
    ...
    if (facility === undefined) {
      ...
      } else if (BitFlags.isAll(facility.loadedDataFlags, GtcAirportInfoPage.REQUIRED_FACILITY_DATA_FLAGS)) {
        selection = facility;
      } else {
        selection = await this.props.facLoader.tryGetFacility(FacilityType.Airport, facility.icaoStruct, GtcAirportInfoPage.REQUIRED_FACILITY_DATA_FLAGS);
      }
    }
  ...
  private async autoSelectFacility(): Promise<AirportFacility | null> {
    ...
    if (activeLegIcao !== undefined && ICAO.isValueFacility(activeLegIcao) && ICAO.getFacilityTypeFromValue(activeLegIcao) === FacilityType.Airport) {
      const activeLegFacility = await this.props.fms.facLoader.tryGetFacility(FacilityType.Airport, activeLegIcao, GtcAirportInfoPage.REQUIRED_FACILITY_DATA_FLAGS);
    ...
    if (lastAirportIcao !== undefined) {
      const lastAirportFacility = this.props.fms.facLoader.tryGetFacility(FacilityType.Airport, lastAirportIcao, GtcAirportInfoPage.REQUIRED_FACILITY_DATA_FLAGS);
        ...
        <div class='airport-info-page-tab airport-info-page-weather'>
          ...
          >
            <div ref={this.listContentRef} class='airport-info-page-weather-list-content'>
              ...
              <div
                class={{
                  'airport-info-page-weather-row': true,
                  'airport-info-page-weather-row-bottom-border': true,
                  'airport-info-page-weather-winddir': true,
              ...
              <div
                class={{
                  'airport-info-page-weather-row': true,
                  'airport-info-page-weather-row-bottom-border': true,
                  'airport-info-page-weather-windspeed': true,
              ...
              <div
                class={{
                  'airport-info-page-weather-row': true,
                  'airport-info-page-weather-row-bottom-border': true,
                  'airport-info-page-weather-windgust': true,
              ...
              <div
                class={{
                  'airport-info-page-weather-row': true,
                  'airport-info-page-weather-row-bottom-border': true,
                  'airport-info-page-weather-vis': true,
              ...
              <div
                class={{
                  'airport-info-page-weather-row': true,
                  'airport-info-page-weather-row-bottom-border': true,
                  'airport-info-page-weather-temp': true,
              ...
              <div
                class={{
                  'airport-info-page-weather-row': true,
                  'airport-info-page-weather-row-bottom-border': true,
                  'airport-info-page-weather-dew': true,
