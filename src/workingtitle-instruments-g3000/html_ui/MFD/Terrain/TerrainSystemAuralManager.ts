  ...
  public constructor(
    ...
    this.alertEntries = new Map([
      ...
      [GarminTawsAlert.GsdGlideslopeCaution, {
        uuid: G3000AuralAlertIds.TawsGsdGlideslopeCaution,
        priority: G3000AuralAlertUtils.PRIORITIES[G3000AuralAlertIds.TawsGsdGlideslopeCaution],
        sequence: {
          [AuralAlertVoiceSetting.Female]: 'aural_glideslope_f',
          [AuralAlertVoiceSetting.Male]: 'aural_glideslope_m'
        },
        timeout: 3000
      }],

      [GarminTawsAlert.GsdGlidepathCaution, {
        uuid: G3000AuralAlertIds.TawsGsdGlidepathCaution,
        priority: G3000AuralAlertUtils.PRIORITIES[G3000AuralAlertIds.TawsGsdGlidepathCaution],
        sequence: {
          [AuralAlertVoiceSetting.Female]: 'aural_glidepath_f',
          [AuralAlertVoiceSetting.Male]: 'aural_glidepath_m'
        },
        timeout: 3000
      }]
    ]);
