...
import { WT21FlightPlanRouteUtils } from '@microsoft/msfs-wt21-shared';

import { WT21FlightPlanRouteLoader } from './WT21FlightPlanRouteLoader';
 ...
 */
export class WT21FlightPlanRouteSyncManager {
  private routeManager?: FlightPlanRouteManager;
  private routeLoader?: WT21FlightPlanRouteLoader;
   ...
   */
  public init(manager: FlightPlanRouteManager, loader: WT21FlightPlanRouteLoader): void {
    if (!this.isAlive) {
    ...
    do {
      ...
      try {
        if (this.fms.hasPrimaryFlightPlan()) {
          route = await WT21FlightPlanRouteUtils.createRouteFromFlightPlan(
            this.fms.facLoader,
