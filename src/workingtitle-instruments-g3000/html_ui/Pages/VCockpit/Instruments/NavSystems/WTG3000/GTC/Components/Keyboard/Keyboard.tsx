import {
  ComponentProps, DisplayComponent, FSComponent, SetSubject, Subject, SubscribableSet, Subscription,
            ...
            {['A', 'B'].map(renderAlphaKey)}
            {
              this.props.showFindButton
                ? (
                  ...
                  >
                    <img
                      src='coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_find.png'
