...
import { G1000FacilityUtils } from '../Navigation/G1000FacilityUtils';
...
export class MapBuilder {
  ...
  public static navMap<MapBuilder extends MapSystemBuilder>(
    ...
    options = {
      ...options,
      userFacilityScopeFilter: scope => scope === G1000FacilityUtils.USER_FACILITY_SCOPE
    };
  ...
  public static ownAirplaneIconOptions(includeNoHeadingIcon = true): MapOwnAirplaneIconOptions {
    const options: MapOwnAirplaneIconOptions = {
      airplaneIconSize: 30,
      airplaneIconSrc: `${G1000FilePaths.ASSETS_PATH}/own_airplane_icon.svg`,
      airplaneIconAnchor: Vec2Math.create(0.5, 0)
    };

    if (includeNoHeadingIcon) {
      options.noHeadingAirplaneIconSrc = `${G1000FilePaths.ASSETS_PATH}/own_airplane_icon_nohdg.svg`;
  ...
  public static miniCompassIconSrc(): string {
    return `${G1000FilePaths.ASSETS_PATH}/map_mini_compass.png`;
  }
}
