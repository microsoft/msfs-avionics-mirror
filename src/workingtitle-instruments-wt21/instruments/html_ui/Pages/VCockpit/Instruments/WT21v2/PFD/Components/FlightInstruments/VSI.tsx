import {
  APEvents, ApproachGuidanceMode, APVerticalModes, ComponentProps, ConsumerSubject, DisplayComponent, EventBus, FSComponent, Subject, Subscription, VNavEvents,
  VNavState, VNode
} from '@microsoft/msfs-sdk';

import { AdcSystemEvents, AdcSystemSelectorEvents, WT21ControlEvents, WT21NavigationUserSettings } from '@microsoft/msfs-wt21-shared';
...
export class VSI extends DisplayComponent<VSIProps> {
   ...
   * @param valid Whether the altitude data is valid
   */
  private onAltitudeDataValidityChanged(valid: boolean): void {
    this.vsiContainerRef.instance.classList.toggle('fail', !valid);
  }
