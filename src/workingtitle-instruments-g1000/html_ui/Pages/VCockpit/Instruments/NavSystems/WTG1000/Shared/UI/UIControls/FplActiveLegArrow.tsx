import { BitFlags, ComponentProps, DisplayComponent, FixTypeFlags, FlightPlan, FSComponent, LegDefinitionFlags, VNode } from '@microsoft/msfs-sdk';
      ...
      switch (state) {
        case ActiveLegStates.NORMAL: {
          if (plan) {
            ...
            if (activeLeg) {
              showActiveArrow = FmsUtils.getFromLegForArrowDisplay(plan, activeLegDef.segmentIndex, activeLegDef.legIndex) !== undefined;
              showDirectArrow = !showActiveArrow;
            }
          }
          break;
        }
