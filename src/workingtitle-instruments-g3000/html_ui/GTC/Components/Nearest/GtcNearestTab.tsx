import {
  AbstractSubscribableArray, ArraySubject, DisplayComponent, EventBus, FacilitySearchType, FacilityType,
  FacilityWaypoint, FSComponent, GeoPoint, GeoPointInterface, GeoPointSubject, MutableSubscribable, SetSubject,
  Subject, Subscribable, SubscribableArray, SubscribableArrayEventType, SubscribableUtils, Subscription, VNode
} from '@microsoft/msfs-sdk';

import { UnitsUserSettings } from '@microsoft/msfs-garminsdk';

import {
  BasicNearestWaypointEntry, DynamicListData, G3000FilePaths, G3000NearestContext, G3000WaypointSearchType,
  NearestWaypointArray, NearestWaypointEntry
    ...
    return (
      <div class={this.rootCssClass}>
        <div class={this.nearestWptFilterClasses}>
          ...
          >
            <img class={this.nearestWptFilterAllClasses} src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_waypoint_info.png`}></img>
            <img class={this.nearestWptFilterAirportClasses} src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_airport.png`}></img>
            <img class={this.nearestWptFilterIntersectionClasses} src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_intersection.png`}></img>
            <img class={this.nearestWptFilterNdbClasses} src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_ndb.png`}></img>
            <img class={this.nearestWptFilterVorClasses} src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_vor.png`}></img>
            <img class={this.nearestWptFilterUserClasses} src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_small_user.png`}></img>
          </GtcListSelectTouchButton>
          <div class='divider' />
        </div>
