 ...
 */
export class GpsNeedle extends CourseNeedleComponent {
    ...
    if (this.props.hsiMap) {
      ...
      return (
        <div ref={this.needleRef} class="hsi-rose-needle-group">
          <svg viewBox="0 0 386 340">
            <path d="M 183 53 l -13.5 13.5 c -0.5 0.5 -0.5 1.5 1.5 1.5 l 8.5 0 c 1.5 0 2 1 2 2 l 0 46 c 0 1 0.5 2 1.5 2 l 2 0 c 1 0 1.5 -1 1.5 -2 l 0 -46 c 0 -1 0.5 -2 2 -2 l 8.5 0 c 2 0 2 -1 1.5 -1.5 l -13.5 -13.5 c -1 -1 -2 0 -2 0 z M 184 249 l -1 0 c -0.5 0 -1.5 0 -1.5 2 l 0 62 c 0 1 0.5 2 1.5 2 l 2 0 c 1 0 1.5 -1 1.5 -2 l 0 -62 c 0 -2 -1 -2 -1.5 -2 z" fill="magenta" stroke="black" stroke-width="1px" />
          ...
          <div ref={this.toFromRef} class="hsi-rose-needle-group">
            <svg viewBox="0 0 386 340">
              <path d="M 184 113 l -12 12 l 24 0 l -12 -12 z" fill="magenta" stroke="black" stroke-width="1px" />
            </svg>
          </div>
          <div ref={this.deviationRef} class="hsi-rose-needle-group">
            <svg viewBox="0 0 386 340">
              <path d="M 184 130 l -1 0 c -1 0 -1.5 1 -1.5 2 l 0 109 c 0 1 0.5 2 1.5 2 l 2 0 c 1 0 1.5 -1 1.5 -2 l 0 -109 c 0 -1 -0.5 -2 -1.5 -2 z" fill="magenta" stroke="black" stroke-width="1px" />
            </svg>
          </div>
        </div>
      );
