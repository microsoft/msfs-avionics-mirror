import {
  ArrayUtils, DisplayComponent, FSComponent, NumberFormatter, NumberUnitSubject, SetSubject, Subscription, UnitType,
  VNode
} from '@microsoft/msfs-sdk';

import {
  ControllableDisplayPaneIndex, FmsSpeedsConfig, FmsSpeedsGeneralLimits, FmsSpeedUserSettingManager, G3000FilePaths,
  NumberUnitDisplay
