import {
  ...
  EngineEvents, EventBus, FacilityLoader, FacilityType, FlightPlanner, FlightPlanPredictor, FSComponent, GNSSEvents, ICAO, LegDefinition,
  LegPredictions, LegType,
  LNavEvents, MathUtils, NumberFormatter, Subject, Subscribable, SubscribableMapFunctions, UnitType, VerticalData, VerticalFlightPhase, VNavEvents, VNavUtils, VNode
} from '@microsoft/msfs-sdk';

import { WT21LNavDataEvents } from '../../../FMC/Autopilot/WT21LNavDataEvents';
import { WT21Fms } from '../../../Shared/FlightPlan/WT21Fms';
import { WT21FmsUtils, WT21LegDefinitionFlags } from '../../../Shared/FlightPlan/WT21FmsUtils';
import { MapUserSettings } from '../../../Shared/Map/MapUserSettings';
import { WT21_PFD_MFD_Colors } from '../../../Shared/WT21_Colors';
...
import { WT21VNavDataEvents } from '../../../Shared/Navigation/WT21VnavEvents';
