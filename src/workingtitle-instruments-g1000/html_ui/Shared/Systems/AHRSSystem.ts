import { ElectricalEvents, EventBus, Subscription } from '@microsoft/msfs-sdk';
...
export class AHRSSystem extends BasicAvionicsSystem<AHRSSystemEvents> {
  ...
  private readonly rollSub: Subscription;
  ...
  constructor(public readonly index: number, protected readonly bus: EventBus) {
    ...
    this.rollSub = this.bus.on('roll_deg', this.onRollChanged, true);
