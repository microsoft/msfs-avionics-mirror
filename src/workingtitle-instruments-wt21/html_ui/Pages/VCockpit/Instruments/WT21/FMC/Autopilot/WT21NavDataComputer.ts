import {
  ...
  LegDefinition, LegDefinitionFlags, LegType, LNavDataVars, LNavEvents, LNavTransitionMode, LNavUtils, MagVar, MathUtils, NavEvents, NavSourceId,
  NavSourceType, ObjectSubject, RnavTypeFlags, SimVarValueType, Subject, UnitType
} from '@microsoft/msfs-sdk';

import { ApproachDetails, WT21Fms } from '../../Shared/FlightPlan/WT21Fms';
...
import { CDIScaleLabel, WT21LNavDataVars } from './WT21LNavDataEvents';
...
export class WT21NavDataComputer {
  ...
  private computeTrackingVars(magVar: number): void {
    ...
    const plan = this.flightPlanner.hasFlightPlan(WT21Fms.PRIMARY_ACT_PLAN_INDEX) && this.flightPlanner.getFlightPlan(WT21Fms.PRIMARY_ACT_PLAN_INDEX);
