...
import { TouchButtonHoldAction, TouchButtonHoldEndReason, TouchButtonOnTouchedAction, TouchButtonProps } from '@microsoft/msfs-garminsdk';
 ...
 */
export interface UiTouchButtonProps
  extends Omit<TouchButtonProps, 'onTouched' | 'onPressed' | 'onHoldStarted' | 'onHoldTick' | 'onHoldEnded' | 'focusOnDrag' | 'class'> {
 ...
 * focus.
 */
export class UiTouchButton extends DisplayComponent<UiTouchButtonProps> implements UiFocusableComponent {
  /** @inheritdoc */
