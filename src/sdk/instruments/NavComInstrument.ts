...
import { ComSpacingChangeEvent, FrequencyBank, Radio, RadioEvents, RadioType } from './RadioCommon';
...
export class NavComInstrument {
  ...
  private simVarSubscriber: EventSubscriber<NavComEvents>;
  ...
  public constructor(bus: EventBus, config: NavComConfig | undefined, numNavRadios: number, numComRadios: number, sync = true) {
    ...
    this.simVarSubscriber = new EventSubscriber<NavComEvents>(this.bus);
