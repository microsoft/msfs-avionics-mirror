import { EventBus, FlightPlanActiveLegEvent, FlightPlanner, FlightPlannerEvents, NavProcessorConfig, NavSource, NavSourceId, NavSourceType } from '@microsoft/msfs-sdk';
