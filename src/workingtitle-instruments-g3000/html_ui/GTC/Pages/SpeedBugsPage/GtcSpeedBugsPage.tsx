...
import { G3000FilePaths, NumberUnitDisplay, ToldUserSettings, VSpeedGroup, VSpeedGroupType } from '@microsoft/msfs-wtg3000-common';
...
interface VSpeedUserValueButtonProps extends Pick<GtcTouchButtonProps, 'isHighlighted' | 'class'> {
  ...
  /** Whether the button's reference V-speed's value can be edited by the user. */
  isEditable: boolean;
  ...
  public render(): VNode {
    ...
    return (
      <GtcTouchButton
        ...
        isEnabled={this.props.isEditable}
      ...
      >
        ...
        />
        <img src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_pencil.png`} class={this.pencilCssClass} />
      </GtcTouchButton>
    );
  }
