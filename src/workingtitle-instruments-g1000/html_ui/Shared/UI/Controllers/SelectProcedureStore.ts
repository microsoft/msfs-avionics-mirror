import { AirportFacility, ArraySubject, EnrouteTransition, LegDefinition, OneWayRunway, Procedure, RunwayTransition, RunwayUtils, Subject } from '@microsoft/msfs-sdk';
