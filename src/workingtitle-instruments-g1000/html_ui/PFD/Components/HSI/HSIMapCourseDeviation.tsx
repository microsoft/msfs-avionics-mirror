import { ComponentProps, DisplayComponent, FSComponent, NavMath, NavSourceType, Subject, VNode, VorToFrom } from '@microsoft/msfs-sdk';

import { NavIndicatorController, NavSensitivity, ObsSuspModes } from '@microsoft/msfs-garminsdk';
