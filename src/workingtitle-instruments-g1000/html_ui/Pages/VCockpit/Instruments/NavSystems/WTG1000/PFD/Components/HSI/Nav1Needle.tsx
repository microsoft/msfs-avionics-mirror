 ...
 */
export class Nav1Needle extends CourseNeedleComponent {
      ...
      return (
        <div ref={this.needleRef} class="hsi-rose-needle-group">
          ...
          <div ref={this.deviationRef} class="hsi-rose-needle-group">
            <svg viewBox="0 0 386 340">
              <path d="M 184 130 l -1 0 c -1 0 -1.5 1 -1.5 2 l 0 109 c 0 1 0.5 2 1.5 2 l 2 0 c 1 0 1.5 -1 1.5 -2 l 0 -109 c 0 -1 -0.5 -2 -1.5 -2 z" fill="rgb(0,255,0)" stroke="black" stroke-width="1px" />
            </svg>
          </div>
        </div>
      );
