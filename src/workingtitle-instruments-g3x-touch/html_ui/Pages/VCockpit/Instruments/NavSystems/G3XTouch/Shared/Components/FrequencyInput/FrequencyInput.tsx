...
import {
  ...
  RadioType, SetSubject, Subject, Subscribable, SubscribableSet, Subscription, ToggleableClassNameRecord, VNode
 ...
 */
export class FrequencyInput extends DisplayComponent<FrequencyInputProps> implements UiInteractionHandler {
