import { ComponentProps, DisplayComponent, EventBus, FSComponent, Subject, Subscribable, Subscription, UserSettingManager, VNode } from '@microsoft/msfs-sdk';
...
class PageTitle extends DisplayComponent<PageTitleProps> {
  ...
  private onOpenPageChanged(page: UiPage | null): void {
    ...
    if (page) {
      this.titlePipe = page.title.pipe(this.textSub);
    } else {
      this.titlePipe = undefined;
    }
  }
