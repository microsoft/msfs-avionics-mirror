...
import {
  AirwayObject, AirwaySegment, ArraySubject, FacilityType, FlightPathCalculator, FlightPlanUtils, FSComponent, ICAO, IntersectionFacility,
...
export class GtcAirwaySelectionDialog extends GtcView<GtcAirwaySelectionDialogProps> implements GtcDialogView<GtcAirwaySelectionDialogInput, GtcAirwaySelectionDialogOutput> {
  ...
  private readonly selectedAirway = Subject.create<AirwayObject | undefined>(undefined);
