import {
  ActiveOrUpcomingLegPredictions, AirportFacility, FacilityLoader, FacilityType, FlightPlanner, FlightPlanPredictor, GeoPoint,
  ICAO, UnitType,
      ...
      if (destinationFacilityIcao && destinationFacilityIcao !== ICAO.emptyIcao) {
        ...
        if (destinationFacility) {
          ...
          if (destinationPredictions) {
            ...
            const altnFacilityIcao = plan.getUserData(WT21Fms.USER_DATA_KEY_ALTN) as string;
