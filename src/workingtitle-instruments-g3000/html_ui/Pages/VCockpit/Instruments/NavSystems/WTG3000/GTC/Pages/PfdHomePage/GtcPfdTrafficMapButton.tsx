...
import { DisplayPaneSettings, DisplayPaneViewKeys, PfdMapLayoutSettingMode, PfdMapLayoutUserSettingTypes } from '@microsoft/msfs-wtg3000-common';
...
export class GtcPfdTrafficMapButton extends DisplayComponent<GtcPfdTrafficMapButtonProps> {
  ...
  public render(): VNode {
    ...
    return (
      ...
      >
        <img src='coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_traffic_map_home.png' class='gtc-pfd-traffic-map-button-img' />
      </ToggleTouchButton>
    );
  }
