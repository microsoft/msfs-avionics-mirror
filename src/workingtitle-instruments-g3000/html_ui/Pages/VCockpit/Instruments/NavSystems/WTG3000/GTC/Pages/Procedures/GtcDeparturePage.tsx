import {
  FSComponent, VNode, Subject, AirportFacility,
  Procedure, EnrouteTransition, OneWayRunway,
  FacilityType, RunwayUtils, MappedSubject,
  LegDefinition, FlightPlan, ArraySubject, FlightPlanLeg, DepartureProcedure, StringUtils, FlightPlanSegmentType,
            ...
            <TouchButton
              ...
              onPressed={(): void => {
                ...
                if (selectedFacility && selectedProc) {
                  ...
                  this.gtcService.changePageTo<GtcFlightPlanPage>(GtcViewKeys.FlightPlan).ref.scrollTo(FlightPlanSegmentType.Departure);
                }
              }}
            />
          </div>
