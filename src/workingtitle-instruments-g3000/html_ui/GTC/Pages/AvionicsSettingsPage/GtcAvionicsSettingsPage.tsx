...
import { AuralAlertsConfig, EspConfig, HorizonDirectorCueOption, TimeDisplay, TouchdownCalloutsConfig } from '@microsoft/msfs-wtg3000-common';
  ...
  private renderSystemTab(contentRef: NodeReference<GtcAvionicsSettingsPageTabContent>, sidebarState: Subscribable<SidebarState | null>): VNode {
    return (
      <GtcAvionicsSettingsPageSystemList
        ...
        espConfig={this.props.espConfig}
      />
    );
  }
