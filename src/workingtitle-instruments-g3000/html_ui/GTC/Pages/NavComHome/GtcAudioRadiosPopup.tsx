import {
  ComponentProps, ComSpacing, ConsumerSubject, DisplayComponent, FSComponent, MappedSubject, MappedSubscribable,
  NavComSimVars, RadioFrequencyFormatter, SetSubject, SimVarValueType, Subject, Subscribable, SubscribableSet,
...
import {
  AdfRadio, ComRadio, ComRadioReceiveMode, DmeRadio, G3000ComRadioUserSettings, G3000FilePaths, G3000NavIndicator,
  G3000RadioType, G3000RadioUtils, NavRadio, NavRadioMonitorUserSettings, Radio, RadiosConfig, TunableRadio
...
import { GtcHorizButtonBackgroundImagePaths } from '../../Components/TouchButton/GtcButtonBackgroundImagePaths';
        ...
        >
          ...
          <div class='right-col split-col'>
            <GtcImgTouchButton
              ...
              imgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_playback_backward.png`}
              isEnabled={false}
              isInList
              gtcOrientation={this.props.gtcService.orientation}
            />
            <GtcImgTouchButton
              class='flex-grow arrow'
              imgSrc={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_playback_forward.png`}
              isEnabled={false}
              isInList
              gtcOrientation={this.props.gtcService.orientation}
            />
