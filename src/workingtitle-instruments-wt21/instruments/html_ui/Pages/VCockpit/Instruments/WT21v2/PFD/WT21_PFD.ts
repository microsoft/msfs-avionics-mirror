...
import { AvionicsConfig } from '@microsoft/msfs-wt21-shared';
...
class WT21_PFD extends FsBaseInstrument<WT21_PFD_Instrument> {
  ...
  constructInstrument(): WT21_PFD_Instrument {
    ...
    return new WT21_PFD_Instrument(this, new AvionicsConfig(this, this.xmlConfig), new PfdInstrumentConfig(this));
  }
