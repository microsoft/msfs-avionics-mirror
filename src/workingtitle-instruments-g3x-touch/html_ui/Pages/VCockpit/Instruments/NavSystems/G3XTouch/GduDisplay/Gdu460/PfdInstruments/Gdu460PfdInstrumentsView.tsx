...
import { AileronRudderTrimGauge } from '../../../PFD/Components/PfdCentralAreaLeftGauges/AileronRudderTrimGauge/AileronRudderTrimGauge';
import { FlapsElevatorTrimGauge } from '../../../PFD/Components/PfdCentralAreaLeftGauges/FlapsElevatorTrimGauge/FlapsElevatorTrimGauge';
...
export class Gdu460PfdInstrumentsView extends AbstractUiView<Gdu460PfdInstrumentsViewProps> {
   ...
   */
  private renderFlapTrimGauges(): VNode {
    return (
      <div class='pfd-flap-trim-gauges'>
        {(this.props.instrumentConfig.flapsGauge !== undefined || this.props.instrumentConfig.useElevatorTrim) && (
          <FlapsElevatorTrimGauge
            bus={this.props.uiService.bus}
            flapsGaugeConfig={this.props.instrumentConfig.flapsGauge}
            useElevatorTrim={this.props.instrumentConfig.useElevatorTrim}
          />
        )}
        {(this.props.instrumentConfig.useAileronTrim || this.props.instrumentConfig.useRudderTrim) && (
          <AileronRudderTrimGauge
            bus={this.props.uiService.bus}
            useAileronTrim={this.props.instrumentConfig.useAileronTrim}
            useRudderTrim={this.props.instrumentConfig.useRudderTrim}
          />
        )}
      </div>
    );
