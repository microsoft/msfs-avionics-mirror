...
import { GNSVersion } from './GNSVersion';
  ...
  public render(): VNode {
    return (
      <div class={`startup-screen ${this.props.gnsType}`} ref={this.el}>
        <img class='startup-screen-logo' src={`${GNSFilePaths.ASSETS_PATH}/Images/garmin_logo_new.svg`} ref={this.logoEl} />
        ...
        <div class='startup-screen-cptext' ref={this.screenRefs[1]}>
          {`Main SW Version 5.40 - ${GNSVersion.VERSION}`}<br />
        ...
        <div class='startup-screen-confirm' ref={this.screenRefs[5]}>
          <div>
            <img src={`${GNSFilePaths.ASSETS_PATH}/Images/basemap_icon.png`} />
            Basemap Land Database via MSFS
          </div>
          <div>
            <img src={`${GNSFilePaths.ASSETS_PATH}/Images/terrain_db_icon.png`} />
            Terrain Database via MSFS
          </div>
          <div>
            <img src={`${GNSFilePaths.ASSETS_PATH}/Images/apt_terrain_db_icon.png`} />
            Airport Terrain Database via MSFS
          </div>
          <div>
            <img src={`${GNSFilePaths.ASSETS_PATH}/Images/aviation_db_icon.png`} />
